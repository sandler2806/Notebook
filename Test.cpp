...
TEST_CASE("Edge cases") {
    ...
    for (int page = 222; page < 227; page++) {//running over 5 pages
        for (int row = 151; row < 156; ++row) {//running over 5 rows
            for (int column = 0; column < 100; ++column) {//running over all the columns
                //running over all the possible lengths of string to this column
                for (int length = 0; length < 101-column ; ++length) {
